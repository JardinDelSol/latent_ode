...
def split_and_subsample_batch(data_dict, args, data_type="train"):
    ...
    # print("split and subsample")
    # print("observed data shape: ", processed_dict["observed_data"].shape)
    # print("observed tp shape: ", processed_dict["observed_tp"].shape)
    # print("data_to_predict shape: ", processed_dict["data_to_predict"].shape)
    # print("tp_to_predict shape: ", processed_dict["tp_to_predict"].shape)
    # print("observed_mask shape: ", processed_dict["observed_mask"].shape)
    # print("mask_predicted_data shape: ", processed_dict["mask_predicted_data"].shape)
...
def compute_loss_all_batches(
    ...
    for i in range(n_batches):
        ...
        results = model.compute_all_losses(
            batch_dict, n_traj_samples=n_traj_samples, kl_coef=kl_coef, test=True
        )
