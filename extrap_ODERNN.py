...
parser.add_argument('--extraprnn', action='store_true', help="Set extrapolation mode for ODE-RNN")
		...
		if itr % (n_iters_to_viz * num_batches) == 0:
			...
			if args.viz:
				with torch.no_grad():
					...
					print("plotting....")
					if (isinstance(model, LatentODE) or isinstance(model, ODE_RNN)) and (args.dataset == "periodic"): #and not args.classic_rnn and not args.ode_rnn:
